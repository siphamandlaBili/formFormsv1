...
function WhoIsItFor() {
  ...
  return (
    <section className="py-20 bg-linear-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-linear-to-r from-blue-100/30 to-purple-100/30 rounded-full blur-3xl"></div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {userTypes.map((userType, index) => {
            ...
            return (
              ...
              >
                <div className="inline-flex items-center justify-center w-16 h-16 bg-linear-to-r from-primary/10 to-primary/5 rounded-xl mb-6 transition-all duration-300 group-hover:scale-110 group-hover:rotate-3">
